...
public class SimpleHttpAsyncClientDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("------" + handler.cancelled());
	...
	public static void send(String url, Map<String, String> map, final String encoding, final AsyncHandler handler)
		...
		client.start();
		// 执行请求操作，并拿到结果（异步）
		Future<HttpResponse> fu = client.execute(httpPost, new FutureCallback<HttpResponse>() {
			...
			public void completed(HttpResponse resp) {
				...
				System.out.println("http/nio整合，返回结果:" + body);
